...
for static scenario-specific tables.

There is deliberately no global leaderboard: throughput and operation rates
have different meanings across scenarios, and reference-client or session
sensitivity constrains some comparisons.
